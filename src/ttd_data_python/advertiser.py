...
from ttd_data_python import errors, models, utils
from ttd_data_python._hooks import HookContext
from ttd_data_python.types import OptionalNullable, UNSET
from ttd_data_python.utils.unmarshal_json_response import unmarshal_json_response
...
class Advertiser(BaseSDK):
        ...
        *,
    ...
    ) -> models.AdvertiserDataServerResponse:
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.AdvertiserDataServerResponse, http_res
            )
        ...
        if utils.match_response(http_res, ["403", "413", "4XX"], "*"):
            ...
            raise errors.TtddataDefaultError(
        ...
        raise errors.TtddataDefaultError("Unexpected response received", http_res)
