...
class GraphQLTransport:
    ...
    def _resolved_ttd_auth(self) -> Optional[str]:
    ...
    def execute(
        ...
        *,
        ...
        POSTs the request and returns the parsed JSON body, authenticated with
        the credential this transport was constructed with — there is no
        per-call override.
        ...
        :raises ValueError: no `ttd_auth` is configured on the client, or it
        ...
        """
        resolved_ttd_auth = self._resolved_ttd_auth()
