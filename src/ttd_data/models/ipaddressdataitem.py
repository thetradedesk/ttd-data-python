...
class IPAddressDataItemTypedDict(TypedDict):
    data: List[IPAddressDataTypedDict]
...
class IPAddressDataItem(BaseModel):
    data: Annotated[List[IPAddressData], pydantic.Field(alias="Data")]
...
try:
    IPAddressDataItem.model_rebuild()
except NameError:
    pass
