...
class IPAddress(BaseSDK):
    def ingest_first_party_ip_address_data(
        ...
        *,
        ...
        items: OptionalNullable[
            Union[
                Iterable[models.IPAddressDataItem],
                Iterable[models.IPAddressDataItemTypedDict],
            ]
        ] = UNSET,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.IngestFirstPartyIPAddressDataResponse(
                ip_address_data_server_response=unmarshal_json_response(
                    Optional[models.IPAddressDataServerResponse], http_res
                ),
                http_meta=models.HTTPMetadata(request=req, response=http_res),
            )
        if utils.match_response(http_res, ["400", "429"], "application/json"):
            response_data = unmarshal_json_response(
                errors.IPAddressDataServerResponseErrorData, http_res
            )
            response_data.http_meta = models.HTTPMetadata(
                request=req, response=http_res
            )
            raise errors.IPAddressDataServerResponseError(response_data, http_res)
    ...
    def ingest_third_party_ip_address_data(
        ...
        *,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return models.IngestThirdPartyIPAddressDataResponse(
                ip_address_data_server_response=unmarshal_json_response(
                    Optional[models.IPAddressDataServerResponse], http_res
                ),
                http_meta=models.HTTPMetadata(request=req, response=http_res),
