...
class Advertiser(BaseSDK):
    def ingest_advertiser_data(
        ...
        *,
        ...
        request = models.AdvertiserDataRequest(
            advertiser_id=advertiser_id,
            data_provider_id=data_provider_id,
            items=utils.get_pydantic_model(
                items, OptionalNullable[List[models.BaseAdvertiserDataItem]]
            ),
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", models.AdvertiserDataRequest
            ),
